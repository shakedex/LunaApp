...
The only things it downloads are the app itself and its decoding engines — about 31 MB,
fetched once and then cached. After that first load, Luna works offline.
